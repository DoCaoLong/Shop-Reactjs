				...
				<div className="modal-content">
					...
					<div className="container-fluid px-xl-0">
						<div className="row align-items-center mx-xl-0">
							<div className="text-center col-12 col-lg-6 col-xl-5 py-4 py-xl-0 px-xl-0">
								{/* Image */}
								<img className="img-fluid" src={productDetail?.thumbnail_url} alt="..." />
								{/* Button */}
								<a className="btn btn-sm  btn-primary" href="./product.html">
									More Product Info <i className="fe fe-info ml-2" />
								</a>
							</div>
							<div className="border-left border-secondary col-12 col-lg-6 col-xl-7 py-9 px-md-9">
								{/* Heading */}
								<h4 className="mb-3">{productDetail?.name}</h4>
								{/* Price */}
								<div className="mb-7">
									<span className="h5">{currency(productDetail?.price)}</span>
										...
										<div className="mb-2">
											...
											<div className="custom-control custom-control-inline custom-control-size mb-2">
												<input
													...
													data-target="#modalProductSizeCaption"
												/>
												<label className="custom-control-label" htmlFor="modalProductSizeEleven">
													11
												</label>
											</div>
											<div className="custom-control custom-control-inline custom-control-size mb-2">
												<input
													...
													data-target="#modalProductSizeCaption"
												/>
												<label className="custom-control-label" htmlFor="modalProductSizeTwelve">
													12
												</label>
											</div>
											<div className="custom-control custom-control-inline custom-control-size mb-2">
												<input
													...
													data-target="#modalProductSizeCaption"
												/>
												<label className="custom-control-label" htmlFor="modalProductSizeThirteen">
													13
												</label>
											</div>
											<div className="custom-control custom-control-inline custom-control-size mb-2">
												<input
													...
													data-target="#modalProductSizeCaption"
												/>
												<label className="custom-control-label" htmlFor="modalProductSizeFourteen">
													14
												</label>
											</div>
										</div>
