                ...
                <div className="card mb-7">
                  ...
                  <div className="card-body px-0">
                    ...
                    <p className="mb-0 text-gray-500">
                      ...
                      good. Open stars day let over gathered, grass face one
                      every light of under.
                    </p>
                    {/* Button */}
                    <a
                ...
                <div className="card mb-7">
                  ...
                  <div className="card-body px-0">
                    ...
                    <p className="mb-0 text-gray-500">
                      ...
                      winged unto our fruit it moveth man replenish. Meat place
                      is so fruit.
                    </p>
                    {/* Button */}
                    <a
              ...
              <div className="col-12 col-md-6">
                ...
                <div className="card mb-7">
                  ...
                  <div className="card-body px-0">
                    ...
                    {/* Text */}
                    <p className="mb-0 text-gray-500">
                      Created spirit fly was fifth. Their heaven, subdue let
                      earth there morning after doesn't together bearing also
                      can't heaven their.
                    </p>
                    {/* Button */}
                    <a
                ...
                <div className="card mb-7">
                  ...
                  <div className="card-body px-0">
                    ...
                    <p className="mb-0 text-gray-500">
                      ...
                      isn't you'll, you're place Years dominion shall from years
              ...
              <div className="col-12 col-md-6">
                ...
                <div className="card mb-7">
                  ...
                  <div className="card-body px-0">
                    ...
                    {/* Text */}
                    <p className="mb-0 text-gray-500">
                      Divide own, there tree forth whales you, fill creepeth
                      our. You're itself may yielding green was fly one kind
                      fish hath be be winged.
                    </p>
                    {/* Button */}
                    <a
                      className="btn btn-link stretched-link px-0 text-reset"
