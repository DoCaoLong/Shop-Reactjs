...
export default function StoreLocation() {
	...
	let [map, setMap] = useState(
		'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3919.2816663015815!2d106.69721651480097!3d10.789725892312536!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x317528caafa7703d%3A0xd655aeb0c7040512!2zMTEgUGhhbiBL4bq_IELDrW5oLCDEkGEgS2FvLCBRdeG6rW4gMSwgVGjDoG5oIHBo4buRIEjhu5MgQ2jDrSBNaW5o!5e0!3m2!1svi!2s!4v1624436027992!5m2!1svi!2s'
	);
	useEffect(() => {
					...
					<div className="row">
						<div className="col-12 col-md-5 col-lg-4">
							...
							>
								...
								{list.map((e, i) => (
									// <ListCardLocation {...e} key={i} Clicked={() => HandleChange(e.name)} />
									// bind(con trỏ this, )
									<ListCardLocation
										{...e}
										key={i}
						...
						<div className="col-12 col-md-7 col-lg-8">
							...
							<div className="embed-responsive embed-responsive-4by3">
								<iframe title="none" src={map}></iframe>
							</div>
						</div>
					</div>
				</div>
